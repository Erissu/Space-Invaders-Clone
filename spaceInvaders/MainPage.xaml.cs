...
public sealed partial class MainPage : Page
{
    ...
    private void PlaySound(string soundFileName)
    {
        try
        {
            ...
            var soundFilePath = System.IO.Path.Combine(AppContext.BaseDirectory, "Sounds", soundFileName);
            var audioReader = new AudioFileReader(soundFilePath);
            var waveOut = new WaveOutEvent();

            //evento para limpar a memória depois que o som terminar de tocar
    ...
    private void StartGame()
    {
        ...
        _alienDirection = 1;
        _player.X = (800 / 2) - (_player.Width / 2);
        _player.Y = 520;
        ...
        GameCanvas.Children.Add(MenuButton);
        _gameTimer.Start();
    }
